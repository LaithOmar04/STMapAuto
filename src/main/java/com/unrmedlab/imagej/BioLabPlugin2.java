...
public class BioLabPlugin2 implements Command {
	...
	public String choiceDialog(String choice) {
		...
		gd.addChoice("Pick mode of operation",
				new String[]{"Batch Processing", "Single Image Processing"}, "Batch Processing");
		gd.showDialog();
		if (gd.wasCanceled()) {
			return choice;
		}
	...
	public void processImage(String img, String output_folder, String classifier, int check)
	...
	public void numberDialog() {
		...
		gd.addNumericField("Pixel height:", 0.0303, 4);
	...
	private String getOutputFolderName(ImagePlus imp) {
